...
use common\models\{AnswersSearch, ExportListSearch, QuestionsSearch, TextSearch};
        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'url' => UserUrl::setFilters(QuestionsSearch::class, ['/questions/index'])
                ],
                [
                    'label' => Yii::t('app', 'Answers'),
                    'url' => UserUrl::setFilters(AnswersSearch::class, ['/answers/index'])
                ],
            ]
        ],
        [
